 ...
 * <p>
 * Created by MVPArmsTemplate on 10/16/2019 14:55
...
public class FragmentLifecycleCallbacksImpl extends FragmentManager.FragmentLifecycleCallbacks {
  ...
  @Override public void onFragmentActivityCreated(FragmentManager fm, Fragment f, Bundle savedInstanceState) {
  ...
  @Override public void onFragmentPaused(FragmentManager fm, Fragment f) {
  ...
  @Override public void onFragmentSaveInstanceState(FragmentManager fm, Fragment f, Bundle outState) {
  ...
  @Override public void onFragmentDestroyed(FragmentManager fm, Fragment f) {
