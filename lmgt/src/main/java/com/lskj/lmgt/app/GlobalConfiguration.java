...
import com.lskj.lmgt.BuildConfig;
import com.lskj.lmgt.mvp.model.api.Api;
...
public final class GlobalConfiguration implements ConfigModule {
    ...
    public void applyOptions(Context context, GlobalConfigModule.Builder builder) {
        ...
        builder.baseurl(Api.APP_DOMAIN)
                ...
                .responseErrorListener(new ResponseErrorListenerImpl()).gsonConfiguration((context1, gsonBuilder) -> {//这里可以自己自定义配置 Gson 的参数
